...
for (v in c("_ce", "_ne", "_ne_ce")) {
  ...
  assign(nome_ora, enrichKEGG(gene = sign.entrez,
  ...
  assign(nome_oraGO, enrichGO(gene = sign.entrez,
              universe = universo.entrez,
              OrgDb = 'org.Hs.eg.db',
              keyType = "ENTREZID",
              ont = "BP",
...
ora_ce@result[1:10,]
ora_ne@result[1:10,]
ora_ne_ce@result[1:10,]

oraGO_ce@result[1:10,]
oraGO_ne@result[1:10,]
oraGO_ne_ce@result[1:10,]
```
...
dotplot(confronto_kegg, showCategory = 10) + 
  ggtitle("Confronto Pathway KEGG tra le regioni del Glioma")
...
for (v in c("_ce", "_ne", "_ne_ce")) {
  ...
  print(dim(get(nome_gse)))
  print(dim(get(nome_gseGO)))
}
...
gse_ne@result[1:10,]
gse_ce@result[1:10,]
gse_ne_ce@result[1:10,]

gseGO_ce@result[1:10,]
gseGO_ne@result[1:10,]
gseGO_ne_ce@result[1:10,]
```
...
plot_ce <- ridgeplot(gse_ce, showCategory = 10) + ggtitle("CE vs Sano")
plot_ne <- ridgeplot(gse_ne, showCategory = 10) + ggtitle("NE vs Sano")
plot_diff <- ridgeplot(gse_ne_ce, showCategory = 10) + ggtitle("CE vs NE")

plot_ceGO <- ridgeplot(gseGO_ce, showCategory = 10) + ggtitle("CE vs Sano")
plot_neGO <- ridgeplot(gseGO_ne, showCategory = 10) + ggtitle("NE vs Sano")
...
capire chi sta a dx e chi a sx
